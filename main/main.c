...
#define PIN_RANGE0     GPIO_NUM_15
#define PIN_RANGE1     GPIO_NUM_16
...
static int cmd_range(int argc, char **argv)
{
    ...
    int r = atoi(argv[1]);
    if (r < 0 || r > 3) { printf("Invalid range\n"); return 1; }
...
static void register_commands(void)
{
    const esp_console_cmd_t cmds[] = {
        ...
        {
            .command = "range",
            .help    = "Set input range: range <0-3>",
            .func    = cmd_range,
        },
        {
            .command = "inttime",
...
void app_main(void)
{
    ...
    printf("\n"
           ...
           "  range <0-3>       - Set full-scale charge range\n"
